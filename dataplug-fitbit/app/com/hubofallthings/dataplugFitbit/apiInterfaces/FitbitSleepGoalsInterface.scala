...
import com.hubofallthings.dataplugFitbit.models.FitbitSleepGoal
...
class FitbitSleepGoalsInterface @Inject() (
  ...
  val endpoint: String = "goals/sleep"
...
object FitbitSleepGoalsInterface {
