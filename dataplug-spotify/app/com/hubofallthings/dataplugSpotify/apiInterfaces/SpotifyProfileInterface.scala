...
import com.hubofallthings.dataplugSpotify.models.SpotifyProfile
...
class SpotifyProfileInterface @Inject() (
  ...
  val defaultApiEndpoint = SpotifyProfileInterface.defaultApiEndpoint
...
object SpotifyProfileInterface {
